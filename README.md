...
The code for the real data analysis is provided in A-Prepare_Data_for_LogLin.R and B-Analyse_Data_HWE_Mas_Loglinear.R. We cannot distribute the real data; information is provided in the manuscript to obtain the data. 
