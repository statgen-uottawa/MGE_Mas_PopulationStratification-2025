...
## - Jul 13 : Changed for a small number of simulations
...
NumControl=1000 # Number of control trios
maf=list(c(0.2,0.4)) # Minor allele frequency
ef=list(c(0.3,0.3))  # Environmental variable frequency
